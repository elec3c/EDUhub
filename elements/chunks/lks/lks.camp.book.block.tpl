<tr>
                                                    ...
                                                    <td><input type="text" name="price[]" class="input input--camp input--w-smd" value="500" placeholder="0"></td>
                                                    <td><input type="text" name="sale[]" class="input input--camp input--w-smd" value="30" placeholder="0"></td>
                                                    <td><input type="text" name="paid[]" class="input input--camp input--w-smd" value="470" placeholder="0"></td>
                                                    <td><input type="text" name="to_pay[]" class="input input--camp input--w-smd" value="0" placeholder="0"></td>
                                                    <td><input type="text" name="tipe[]" class="input input--camp input--w-smd" value="9-12" placeholder="9-12"></td>
