{set $where = ["template:=" => "8", "course_popular:=" => "1"]}
...
{set $result = '!pdoResources' | snippet : [
    'tpl'=>'@FILE chunks/courses/courses.popular.carousel.row.tpl',
    'sortby'=>'{"data_from":"asc"}',
    'parents'=>$_modx->config['site_parent_courses'],
    'depth'=>2,
    'includeTVs' => 'small_image,course_group_title,data_from,data_to,course_owner,form_of_study,price_lesson,course_popular',
    'processTVs'=>1,
    'limit'=>12,
    'where' => $where
]}
