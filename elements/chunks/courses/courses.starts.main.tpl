...
{set $result = '!pdoResources' | snippet : [
    ...
    'includeTVs' => 'course_template,num_months_of_study,course_category, course_sub_category, schedule, time, form_of_study, course_city, small_image,course_group_title,data_from,data_to,course_owner,form_of_study,course_duration,num_people_in_group,sale,price_course,price_course_month',
    'processTVs'=>1,
    'limit'=>12,
    'where' => $where
]}
    ...
    <div class="container filtering">
        ...
        <div class="section__head section__head--cols">
            ...
            <div class="section__head-right">
                ...
                <a class="btn" style="height:42px; width:200px;margin-right:10px;" href="{1718 | url}">
