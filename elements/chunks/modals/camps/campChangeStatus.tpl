<div class="popup" data-popup="campChangeStatus">
        ...
        <div class="popup__container">
            ...
            <div class="popup__body">
                <div class="popup__head">
                    <div class="popup__title">Смена статуса публикации</div>
                </div>
                {'!FetchIt' | snippet : [
                    'snippet' => 'changeStatusCamp',
                    'form' => '@FILE chunks/camp/forms/changeStatus.tpl',
