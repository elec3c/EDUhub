                    ...
                    <div class="kviz__step js-step-form js-step-radio active" data-step="1">
                        ...
                        <div class="kviz__body">
                            <div class="form__row">
                                ...
                                <select class="styler styler--camp" name="course_category" data-placeholder="Категория курса" id="category-select" required>
                            ...
                            <div class="form__row">
                                ...
                                <select class="styler styler--camp" name="course_sub_category" data-placeholder="Подкатегория курса" id="sub_category-select" required>
                                    <option class="option-hide" value="">&nbsp;</option>
                            ...
                            <div class="form__row">
                                ...
                                <select class="styler styler--camp" name="course_sub_category_type" data-placeholder="Направление " id="sub_category_type-select">
                                    <option class="option-hide" value="">&nbsp;</option>
                            ...
                            <div class="form__row">
                                ...
                                <select class="styler styler--camp" name="course_type" id="type-select" data-placeholder="Особенности">
                                    <option class="option-hide" value="">&nbsp;</option>
                    ...
                    <div class="kviz__step js-step-form js-step-radio " data-step="3">
                        ...
                        <div class="kviz__body">
                            <div class="form__row">
                                ...
                                <select class="styler styler--camp" name="for_ages" data-placeholder="Возраст">
                                    <option class="option-hide" value="">&nbsp;</option>
                            ...
                            <div class="form__row">
                                ...
                                <select class="styler styler--camp" name="for_levels" id="level-select" data-placeholder="Уровень">
                                    <option class="option-hide" value="">&nbsp;</option>
