                ...
                <div class="cmp_lktables fs--sm">
                    <table>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="time[]" class="input input--camp input--w-smx" value="9-12" placeholder="№"></td>
                            <td><input type="text" name="sum[]" class="input input--camp input--w-smx" value="350" placeholder="№"></td>
                            <td><input type="text" name="sale[]" class="input input--camp input--w-smx" value="20" placeholder="№"></td>
                            <td><input type="text" name="comment[]" class="input input--camp input--comment" value="аллергия на апельсины" placeholder="Примечание"></td>
                            <td>
