        ...
        <section class="lk cadd section__mgb">
            ...
            {if ($.get.edit is empty)}
                ...
                {'!AjaxForm'|snippet:[
                    ...
                    'validate' => 'course_group_title:required,introtext:required,data_from:required,data_to:required,course_category:required,course_sub_category:required,course_type:required,course_city:required,price_course:required,price_lesson:required',
                    'template' => 8,
