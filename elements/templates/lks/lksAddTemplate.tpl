        ...
        <section class="lk cadd section__mgb">
            ...
            {if ($.get.edit is empty)}
                ...
                {'!AjaxForm'|snippet:[
                    ...
                    'validate' => 'nospam:blank,data_from:required,data_to:required,course_category:required,course_sub_category:required,course_type:required,course_city:required,price_course:required,price_lesson:required',
                    'template' => 8,
                    'redirectTo' => 36,
            ...
            {else}
                ...
                {'!AjaxForm'|snippet:[
                    ...
                    'resource2formitfields' => 'course_duration,course_city,course_region,course_metro,price_course,price_lesson,sale,form_of_study,format_of_study,for_ages_from,for_ages_to,for_levels_from,for_levels_to,num_people_in_group,course_category,course_sub_category,course_type,data_from,data_to,lesson_duration,num_lesson_per_week',
                    'hooks' => 'FormIt2Resource',
                    'validate' => 'nospam:blank,data_from:required,data_to:required,category:required,sub_category:required,type:required,course_city:required,price_course:required,price_lesson:required',
                    'template' => 8,
                    'redirectTo' => 36,
                    'validationErrorMessage' => 'В форме содержатся ошибки!',
