        ...
        <section class="lk cadd section__mgb">
            ...
            {if ($.get.edit is empty)}
                ...
                {'!AjaxForm'|snippet:[
                    ...
                    'validate' => 'nospam:blank,introtext:required,data_from:required,data_to:required,course_category:required,course_sub_category:required,course_type:required,course_city:required,price_course:required,price_lesson:required',
                    'template' => 8,
                    'redirectTo' => 36,
            ...
            {else}
                ...
                {'!AjaxForm'|snippet:[
                    ...
                    'hooks' => 'FormIt2Resource',
                    'validate' => 'nospam:blank,introtext:required,data_from:required,data_to:required,category:required,sub_category:required,type:required,course_city:required,price_course:required,price_lesson:required',
                    'template' => 8,
                    'redirectTo' => 36,
                    'validationErrorMessage' => 'В форме содержатся ошибки!',
