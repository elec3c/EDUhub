        ...
        <section class="cmp_create section__mg section__first">
            <div class="container">
                <div class="section__head section__head--cols mb--md">
                    <h2 class="section__title">Договоры</h2>
                </div>
                
                
                <div class="lk__nav lk__nav--camp">
                    <ul>
                        <li><a href="camp-lk-leads.html">Лиды</a></li>
                ...
                <div class="cmp_lknav">
                    <a href="#" class="cmp_lknav__item active">г. Минск, ул. Острова 19</a>
                    <a href="#" class="cmp_lknav__item">г. Минск, ул. Острова 19</a>
                    <a href="#" class="cmp_lknav__item">Выбрать все</a>
                </div>
            ...
            <div class="container container--lg">
                <div class="cmp_lktables fs--sm">
                    <table>
                        ...
                        <tr>
                            <td class="">Александровская Александра Александровна</td>
                            <td>
                            ...
                            <td>г.Минск ул. Уручская,19</td>
                            <td><input type="text" name="cabinet[]" class="input input--camp input--w-smx" value="12" placeholder="№"></td>
                            <td><input type="text" name="shift[]" class="input input--camp input--w-smx" value="1" placeholder="Смена"></td>
                            <td><input type="text" name="group[]" class="input input--camp input--w-smx" value="15" placeholder="№"></td>
                            <td><input type="text" name="time[]" class="input input--camp input--w-smx" value="9-12" placeholder="9-12"></td>
                            <td><input type="text" name="sum[]" class="input input--camp input--w-smx" value="350" placeholder="0"></td>
                            <td><input type="text" name="sale[]" class="input input--camp input--w-smx" value="20" placeholder="0"></td>
                            <td><input type="text" name="to_pay[]" class="input input--camp input--w-smx" value="20" placeholder="0"></td>
                            <td><div class="input__hhint">
                                    <input type="text" name="comment[]" class="input input--camp input--comment" value="аллергия на апельсины" placeholder="аллергия на апельсин,на кошек">
                                    <div class="input__hhint-hint p-right"><div class="input__hhint-wrap">аллергия на апельсин,на кошек</div></div>
                                </div>
                            </td>
                            <td>
                ...
                <div class="cmp_create__buttons gap--sm">
                    ...
                    <button class="btn btn--bdpurple btn--sm" type="button">Отмена</button>
                </div>
            </div>
        </section><!--  -->
{/block}
