    ...
    <main class="content__wrapper">
        ...
        <section class="lk section__mgb">
            <div class="container">
                ...
                <div class="scools__items">
                    <div class="scools__item">
                        <a href="detail-scool.html" class="scools__item-link">

                            <div class="scools__item-photo"><img src="assets/images/courses/3.jpg" alt=""></div>
                            <div class="scools__item-info">
                                <div class="scools__item-title">Skillbox</div> 
                                <ul class="scools__item-list listinf">
                                    <li class="listinf__flex"><div class="listinf__icon">
                                        ...
                                        </div> <div class="listinf__str">Москва</div></li>
                                    <li class="listinf__flex"><div class="listinf__icon">
                                    ...
                                    </div> <div class="listinf__str">skillbox.ru</div></li>
                                    <li class="listinf__flex"><div class="listinf__icon">
                                        <svg width="20" height="22" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    </div> <div class="listinf__str">3 курса</div></li>
                                </ul>
                            </div>
                        </a>
                        <button class="favour active scools__item-favour">
                    ...
                    <div class="scools__item">
                        <a href="detail-scool.html" class="scools__item-link">
                            ...
                            <div class="scools__item-photo"><img src="assets/images/courses/6.jpg" alt=""></div>
                            <div class="scools__item-info">
                                <div class="scools__item-title">Geekbrains</div> 
                                <ul class="scools__item-list listinf">
                                    <li class="listinf__flex"><div class="listinf__icon">
                                        <svg width="20" height="22" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M9.99891 12.4299C11.722 12.4299 13.1189 11.0331 13.1189 9.30994C13.1189 7.58681 11.722 6.18994 9.99891 6.18994C8.27578 6.18994 6.87891 7.58681 6.87891 9.30994C6.87891 11.0331 8.27578 12.4299 9.99891 12.4299Z" stroke="#7D7D7D"/>
                                        ...
                                        </div> <div class="listinf__str">Минск</div></li>
                                    <li class="listinf__flex"><div class="listinf__icon">
                                        <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M11 21C16.5228 21 21 16.5228 21 11C21 5.47715 16.5228 1 11 1C5.47715 1 1 5.47715 1 11C1 16.5228 5.47715 21 11 21Z" stroke="#7D7D7D" stroke-linecap="round" stroke-linejoin="round"/>
                                            <path d="M7.00156 2H8.00156C6.05156 7.84 6.05156 14.16 8.00156 20H7.00156" stroke="#7D7D7D" stroke-linecap="round" stroke-linejoin="round"/>
                                    ...
                                    </div> <div class="listinf__str">geekbrains.by</div></li>
                                    <li class="listinf__flex"><div class="listinf__icon">
                                        <svg width="20" height="22" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M19 6V16C19 19 17.5 21 14 21H6C2.5 21 1 19 1 16V6C1 3 2.5 1 6 1H14C17.5 1 19 3 19 6Z" stroke="#7D7D7D" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                            <path d="M12.5 3.5V5.5C12.5 6.6 13.4 7.5 14.5 7.5H16.5" stroke="#7D7D7D" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                    ...
                                    </div> <div class="listinf__str">10 курсов</div></li>
                                </ul>
                            </div>
                        </a>
                        <button class="favour active scools__item-favour">
                    ...
                    <div class="scools__item">
                        <a href="detail-scool.html" class="scools__item-link">
                            ...
                            <div class="scools__item-photo"><img src="assets/images/courses/1.jpg" alt=""></div>
                            <div class="scools__item-info">
                                <div class="scools__item-title">Skillfactory</div> 
                                <ul class="scools__item-list listinf">
                                    <li class="listinf__flex"><div class="listinf__icon">
                                        <svg width="20" height="22" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M9.99891 12.4299C11.722 12.4299 13.1189 11.0331 13.1189 9.30994C13.1189 7.58681 11.722 6.18994 9.99891 6.18994C8.27578 6.18994 6.87891 7.58681 6.87891 9.30994C6.87891 11.0331 8.27578 12.4299 9.99891 12.4299Z" stroke="#7D7D7D"/>
                                    ...
                                    </div> <div class="listinf__str">Skillfactory.team</div></li>
                                    <li class="listinf__flex"><div class="listinf__icon">
                                        <svg width="20" height="22" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M19 6V16C19 19 17.5 21 14 21H6C2.5 21 1 19 1 16V6C1 3 2.5 1 6 1H14C17.5 1 19 3 19 6Z" stroke="#7D7D7D" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                            <path d="M12.5 3.5V5.5C12.5 6.6 13.4 7.5 14.5 7.5H16.5" stroke="#7D7D7D" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                    ...
                    <div class="scools__item">
                        <a href="detail-scool.html" class="scools__item-link">
                            ...
                            <div class="scools__item-photo"><img src="assets/images/courses/7.jpg" alt=""></div>
                            <div class="scools__item-info">
                                <div class="scools__item-title">Skypro</div> 
                                <ul class="scools__item-list listinf">
                                    <li class="listinf__flex"><div class="listinf__icon">
                                        <svg width="20" height="22" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M9.99891 12.4299C11.722 12.4299 13.1189 11.0331 13.1189 9.30994C13.1189 7.58681 11.722 6.18994 9.99891 6.18994C8.27578 6.18994 6.87891 7.58681 6.87891 9.30994C6.87891 11.0331 8.27578 12.4299 9.99891 12.4299Z" stroke="#7D7D7D"/>
                                    ...
                                    </div> <div class="listinf__str">sky.pro</div></li>
                                    <li class="listinf__flex"><div class="listinf__icon">
                                        <svg width="20" height="22" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M19 6V16C19 19 17.5 21 14 21H6C2.5 21 1 19 1 16V6C1 3 2.5 1 6 1H14C17.5 1 19 3 19 6Z" stroke="#7D7D7D" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                            <path d="M12.5 3.5V5.5C12.5 6.6 13.4 7.5 14.5 7.5H16.5" stroke="#7D7D7D" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                    ...
                    <div class="scools__item">
                        <a href="detail-scool.html" class="scools__item-link">
                            ...
                            <div class="scools__item-photo"><img src="assets/images/courses/4.jpg" alt=""></div>
                            <div class="scools__item-info">
                                <div class="scools__item-title">IMBA</div> 
                                <ul class="scools__item-list listinf listinf">
                                    <li class="listinf__flex"><div class="listinf__icon">
                                        <svg width="20" height="22" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M9.99891 12.4299C11.722 12.4299 13.1189 11.0331 13.1189 9.30994C13.1189 7.58681 11.722 6.18994 9.99891 6.18994C8.27578 6.18994 6.87891 7.58681 6.87891 9.30994C6.87891 11.0331 8.27578 12.4299 9.99891 12.4299Z" stroke="#7D7D7D"/>
                                            <path d="M1.62166 7.49C3.59166 -1.17 16.4217 -1.16 18.3817 7.5C19.5317 12.58 16.3717 16.88 13.6017 19.54C11.5917 21.48 8.41166 21.48 6.39166 19.54C3.63166 16.88 0.471662 12.57 1.62166 7.49Z" stroke="#7D7D7D"/>
                                    ...
                                    </div> <div class="listinf__str">imba.ru</div></li>
                                    <li class="listinf__flex"><div class="listinf__icon">
                                        <svg width="20" height="22" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M19 6V16C19 19 17.5 21 14 21H6C2.5 21 1 19 1 16V6C1 3 2.5 1 6 1H14C17.5 1 19 3 19 6Z" stroke="#7D7D7D" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                            <path d="M12.5 3.5V5.5C12.5 6.6 13.4 7.5 14.5 7.5H16.5" stroke="#7D7D7D" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                    ...
                                    </div> <div class="listinf__str">42 курса</div></li>
                                </ul>
                            </div>
                        </a>
                        <button class="favour active scools__item-favour">
                    ...
                    <div class="scools__item">
                        <a href="detail-scool.html" class="scools__item-link">
                            ...
                            <div class="scools__item-photo"><img src="assets/images/courses/2.jpg" alt=""></div>
                            <div class="scools__item-info">
                                <div class="scools__item-title">Advance</div> 
                                <ul class="scools__item-list listinf">
                                    <li class="listinf__flex"><div class="listinf__icon">
                                        <svg width="20" height="22" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M9.99891 12.4299C11.722 12.4299 13.1189 11.0331 13.1189 9.30994C13.1189 7.58681 11.722 6.18994 9.99891 6.18994C8.27578 6.18994 6.87891 7.58681 6.87891 9.30994C6.87891 11.0331 8.27578 12.4299 9.99891 12.4299Z" stroke="#7D7D7D"/>
                                    ...
                                    </div> <div class="listinf__str">advance-club.ru</div></li>
                                    <li class="listinf__flex"><div class="listinf__icon">
                                        <svg width="20" height="22" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M19 6V16C19 19 17.5 21 14 21H6C2.5 21 1 19 1 16V6C1 3 2.5 1 6 1H14C17.5 1 19 3 19 6Z" stroke="#7D7D7D" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                            <path d="M12.5 3.5V5.5C12.5 6.6 13.4 7.5 14.5 7.5H16.5" stroke="#7D7D7D" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
