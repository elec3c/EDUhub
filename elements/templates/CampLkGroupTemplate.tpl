        ...
        <section class="cmp_create section__mg section__first">
            <div class="container container--lg">
                ...
                <div class="section__head section__head--cols mb--md">
                    <h2 class="section__title">Создание группы</h2>
                </div>
                {/if}
                ...
                {if ($res_tpl) && ($isCampOwner)}
                    ...
                    <form action="" method="post" class="js-cmp-tbform-group" data-user="{$_modx->user.id}" data-pid="{$.get.id?:2022}">
                        <table>
