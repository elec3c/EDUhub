        ...
        <div id="pdopage">
            ...
            {*
                    ...
                    'innerJoin'=>[
                        'modTemplateVarResource'=>[
                            'class'=>'modTemplateVarResource',
                            'on'=>'modResource.id = modTemplateVarResource.contentid AND modTemplateVarResource.tmplvarid = 43'
                        ],
                        'EduSubscribe'=>[
                            'class'=>'EduSubscribe',
                            'on'=>'EduSubscribe.userid = modTemplateVarResource.value AND EduSubscribe.serviceid = 2'
                        ]                        
                    ],  
