...
{if isset($schools_id) && intval($schools_id) && ($schools_id | ismember : ['Organization'])}
    {set $where["course_owner:="] = $schools_id}
    {if isset($course_template) && intval($course_template)}
        {set $where["course_template:="] = $course_template}
    {/if}
{/if}
...
{set $result = '!pdoResources' | snippet : [
    ...
    'includeTVs' => 'course_template,num_months_of_study,small_image,course_group_title,data_from,data_to,course_owner,form_of_study,course_duration,course_continue,data_continue,num_people_in_group, time, course_city,schedule,course_category,course_sub_category,sale,price_course,price_course_month',
    'processTVs'=>1,
    'limit'=>12,
    'where' => $where
]}
        ...
        <div class="section__head section__head--cols">
            ...
            <div class="section__head-right">
                <div class="swiper-button-nav">
                    ...
                    <a class="btn" style="height:42px; width:200px;margin-right:10px;" href="{1717 | url}">
