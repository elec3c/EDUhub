<div class="popup " data-popup="partnership_dogovor_wait_add">
		...
		<div class="popup__container">
			...
			<div class="popup__body">
				<div class="popup__head">
                    ...
                    {if $isSchool}
					    <div class="popup__title" id="partnership_dogovor_add_text">Когда компания примет ваше предложение, соглашение о скидках будет считаться подписанным и скидки вступят в силу.</div>
					{else}
                        <div class="popup__title" id="partnership_dogovor_add_text">После подтверждения, соглашение о скидках бужет считаться подписанным и скидки вступят в силу.</div>
					{/if}
				</div>
