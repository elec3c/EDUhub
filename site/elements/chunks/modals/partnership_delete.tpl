<div class="popup " data-popup="partnership_delete">
		...
		<div class="popup__container">
			...
			<div class="popup__body">
				<div class="popup__head">
                    ...
                    {if $isSchool}
					    <div class="popup__title"><b style="color:red">Запрос участия в партнерской программе можно будет восстановить!</b><br>Вы уверены, что хотите <br> удалить текущее партнерское предложение?</div>
					{else}
					    <div class="popup__title">Вы уверены, что хотите <br> удалить?</div>
					{/if}
				</div>
				<button class="btn btn--red w-all delete_partnership">Удалить</button>
