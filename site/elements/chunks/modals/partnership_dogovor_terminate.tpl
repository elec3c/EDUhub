<div class="popup " data-popup="partnership_dogovor_terminate">
		...
		<div class="popup__container">
			...
			<div class="popup__body">
				<div class="popup__head">
                    ...
                    {if $isSchool}
					    <div class="popup__title"><b style="color:red">Участие в партнерской программе нельзя будет восстановить!</b><br>Вы уверены, что хотите <br> расторгнуть договор?</div>
					{else}
					    <div class="popup__title">Вы уверены, что хотите <br> расторгнуть договор для участия в данной партнерской программе?</div>
					{/if}
				</div>
				<button class="btn btn--red w-all reject_partnership">Расторгнуть</button>
