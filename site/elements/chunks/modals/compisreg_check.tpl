<div class="popup popup-copmisreg" data-popup="compisreg">
	<div class="popup__content">
		...
		<div class="popup__container">
			...
			<div class="popup__body">
                ...
                {var $subject  = $subject  ?: 'Сообщение с формы запроса на добавление компании с сайта '  ~ $_modx->config.http_host}
                {var $emailto  = $emailto  ?: $_modx->config.emailto}
                {var $validate = $validate ?: 'name:required,comment:required'}
                {var $success  = $success  ?: 'Сообщение успешно отправлено.'}
                {var $error    = $error    ?: 'В форме содержатся ошибки!'}
                {var $form      = $tpl      ?: '@FILE chunks/forms/compisreg.form.tpl'}
