<div class="popup popup-thank" data-popup="tender_dogovor_thank">
	<div class="popup__content">
		<div class="popup__bg popup-close"></div>
		<div class="popup__container">
			<a href="#" class="popup__close popup-close" onClick="window.location.reload();">
			...
			<div class="popup__body">
				<div class="popup__title">Спасибо, что воспользовались нашими услугами.<br> Оставьте, пожалуйста, оценку и отзыв об учебном центре после окончания обучения.</div>				
			</div>
