<div class="popup " data-popup="promote_buy">
		...
		<div class="popup__container">
			...
			<div class="popup__body">
				<div class="popup__head">
					<div class="popup__title">Вы уверены, что хотите <br> продвигать данную группу?</div>
				</div>

				<button class="btn btn--red w-all buy_promote">Продвигать</button>
