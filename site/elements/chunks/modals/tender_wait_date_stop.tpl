<!-- Удаление скидки -->
<div class="popup " data-popup="tender_wait_date_stop">
		...
		<div class="popup__container">
			...
			<div class="popup__body">
				<div class="popup__head">
					<div class="popup__title">Заключить договор досрочно нельзя. Ожидайте дату окончания приема заявок на тендер.</div>
				</div>
