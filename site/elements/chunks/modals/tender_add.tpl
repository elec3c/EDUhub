<!-- Удаление скидки -->
<div class="popup " data-popup="tender_add">
		...
		<div class="popup__container">
			...
			<div class="popup__body">
				<div class="popup__head">
                    ...
                    {if $isSchool}
					    <div class="popup__title">Приняв тендер вы не сможете отказаться от него до его окончания</div>
					{else}
                        <div class="popup__title">Приняв тендер вы не сможете отказаться от него до его окончания</div>					
					{/if}
				...
				<button class="btn btn--red w-all accept_tender">Принять</button>
