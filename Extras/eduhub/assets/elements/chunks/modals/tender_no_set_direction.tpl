<!-- Удаление скидки -->
<div class="popup " data-popup="tender_no_set_direction">
		...
		<div class="popup__container">
			...
			<div class="popup__body">
				<div class="popup__head">
					<div class="popup__title">Укажите категорию корпоративных курсов в настройках.</div>
				</div>
<a class="btn btn--red w-all" href="{816 | url}">Перейти в настройки</a>
