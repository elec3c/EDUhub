...
Ext.extend(eduhub.grid.Items, MODx.grid.Grid, {
    windows: {},
    ...
    getMenu: function (grid, rowIndex) {
        ...
        var menu = eduhub.utils.getMenu(row.data['actions'], this, ids);
    ...
    getColumns: function () {
        return [{
            ...
            dataIndex: 'active',
            renderer: eduhub.utils.renderBoolean,
            sortable: true,
            width: 100,
        }, {
            header: _('eduhub_grid_actions'),
            dataIndex: 'actions',
            renderer: eduhub.utils.renderActions,
            sortable: false,
            width: 100,
            id: 'actions'
        }];
    ...
    getTopBar: function () {
        return [{
            text: '<i class="icon icon-plus"></i>&nbsp;' + _('eduhub_item_create'),
            handler: this.createItem,
            scope: this
        }, '->', {
            xtype: 'eduhub-field-search',
            width: 250,
            listeners: {
                search: {
                    fn: function (field) {
